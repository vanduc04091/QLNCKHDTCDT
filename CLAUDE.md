...
- ✅ **Seed** `seed_cme.php` (chạy: `php seed_cme.php`, idempotent theo `ma_nhom`/`ma_loai`): nạp 5 nhóm + 24 loại từ Bảng quy đổi kèm Thông báo + 2 key cấu hình ngưỡng `CME_NGUONG_GIO=48`, `CME_CHU_KY_NAM=2` vào `DM_CAU_HINH`.
